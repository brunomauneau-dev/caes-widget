...
(function () {
  ...
  function addExplicitFilters(schema, q, filters, reasons) {
    ...
    if (/boursier|boursiers|bourse|crous/.test(q)) {
      ...
      if (e) {
        ...
        const v = booleanValue(e, !neg) || findValue(e, [neg ? 'non' : 'oui', neg ? 'false' : 'true', neg ? '0' : '1']);
        if (v) upsertCandidateFilter(filters, { entry: e, item: v, alias: neg ? 'non boursier' : 'boursier', op: 'eq', score: 320 }, reasons);
      } else {
  ...
  window.buildPlannerPlan = function buildPlannerPlan(question, filterContextText, table, forcedTool = null) {
    ...
    return {
      ...
      question,
      planner: {
        version: 'v18-planner-v2.2-concept-boursier-fix',
        confidence,
        reasons,
        schema: {
