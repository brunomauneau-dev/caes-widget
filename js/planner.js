/* planner.js — Planner V1.2 pour Parcoursup Data Copilot.
   Rôle : transformer une question en plan d'exécution exploitable par le Data Engine.
   Correctifs V1.2 :
   - construit un score de priorité des colonnes à partir du schéma Grist ;
   - déduplique les colonnes sémantiquement équivalentes (ex. Type de la classe vs Série de la Classe) ;
   - privilégie les colonnes d'accueil/acceptées pour les demandes sur les formations choisies ;
   - limite les filtres parasites sur les valeurs génériques.
*/
